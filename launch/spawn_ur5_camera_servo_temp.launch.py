...
def generate_launch_description():
    ...
    # from appelpluk
    servo_output_params = os.path.join(
        get_package_share_directory("ur_yt_sim"),
        "config",
        "servo_jtc.yaml",
    )
    ...
    servo_params = {
        "moveit_servo": ParameterBuilder("ur_yt_sim")
        .yaml("config/pose_tracking_settings.yaml")
        .yaml("config/servo_ur_pose_tracking.yaml")
        .yaml(servo_output_params)
        .to_dict()
    }
    low_pass_filter_coeff = {"low_pass_filter_coeff": 2.0}
    ...
    # servo type
    # servo_type = LaunchConfiguration("servo_type") 
    # set_servo_type = ExecuteProcess(
    #     cmd=[
    #         "ros2", "service", "call",
    #             "/servo_node/switch_command_type",
    #             "moveit_msgs/srv/ServoCommandType",
    #             f"{{command_type: {servo_type.perform(context)}}}"
    #     ],
    #     output="screen"
    # )
